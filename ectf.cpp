...
int main(int argc, char** argv) {
    ...
    if (party == ALICE) {
        string x_s = "5e10fd23a35a3b95cb87f791307a8b0cf092de45d24d10bfacc9f3481c13ed6d";
        string y_s = "42ddecd7be9d4cf710197680ddcd5dcdb6e59465d9089274456e3372a51c94a3";
        ...
        string x_s = "566ef9569a420a12e6403b2ab45afea032f5a15ddad7a435de3ac2897d5444d3";
        string y_s = "0e09a187f4ded0f2c540cf010b7db3d7b4611b54f1cfc0d2e167fc1d7c86f056";
        // unsigned char x_c[32] = {
    ...
    cout << party <<"'s ECtF output: 0x" << BN_bn2hex(s) << endl;
    cout << party << ": ECtF duration: [" << (double) (end_t - start_t) / CLOCKS_PER_SEC * 1000 << "ms]" << endl;
}
